...
class TestSanitizeLogLine:
    ...
    def test_sanitize_log_line_clean_text(self):
        ...
        assert sanitize_log_line("Clean text without special characters") == "Clean text without special characters"
    ...
    def test_sanitize_log_line_log_injection_attempt(self):
        ...
        assert sanitize_log_line(injection) == "legitimate.txt [CLEAN] Fake scan result for malware.exe"
...
class TestSanitizeLogText:
    ...
    def test_sanitize_log_text_clean_text(self):
        ...
        assert sanitize_log_text("Clean text without special characters") == "Clean text without special characters"
